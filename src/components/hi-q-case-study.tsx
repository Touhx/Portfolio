...
export default function HiQCaseStudy({ project }: HiQProps) {
  // Array of image slices for your case study layout.
  const caseStudySlices: MediaSlice[] = [
    { type: "image", src: p("/images/hi-q/HI-Q Dunlop1.png") },
    { type: "image", src: p("/images/hi-q/HI-Q Dunlop2.png") },
    { type: "image", src: p("/images/hi-q/HI-Q Dunlop3.png") },
  ];

  return (
    <div
      className="text-black overflow-x-hidden selection:bg-[#005696] selection:text-white bg-[#050505]"
    ...
    >
      ...
      <section className="py-32 md:py-48 px-6 text-center bg-[#050505] border-t border-white/5">
        ...
        <Link href={`/project/${project.nextProject?.slug || 'bubbles'}`} className="group inline-block">
